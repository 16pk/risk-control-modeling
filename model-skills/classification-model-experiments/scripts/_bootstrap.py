# -*- coding: utf-8 -*-
"""把 model-skills/_modelevo-shared/scripts 注入 sys.path，让本 skill 脚本可直接 import config_io / metrics 等公共模块。

仅 import 一次即可生效。_modelevo-shared/ 由 install.sh 从仓库根复制到 model-skills/ 下，
与 data-cleaning / training / tuning 等 skill 的 _bootstrap.py 行为一致。
"""
import sys
